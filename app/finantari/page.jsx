                ...
                {!error && data && Array.isArray(data) && data.length > 0 && (
                    <div className="p-8 lg:p-16 gap-8 lg:gap-16 grid grid-cols-1 md:grid-cols-2 max-w-screen-2xl w-full perspective-800">
                        {data.map(availableFinancing => (
                            ...
                            <Link href={`/finantari/${availableFinancing.slug}`} className="line-clamp-2 text-black text-lg font-semibold hover:underline">
                                ...
                                <span className="line-clamp-2 text-center w-full font-semibold">
                                    {availableFinancing.program.name}
                                        ...
                                        <Image src={availableFinancing.program.type.logo.path} width={50}
                                               alt={availableFinancing.program.type.logo.title || ""} height={50}/>
                                        <Image src={availableFinancing.program.where_to_apply.logo.path} width={50}
                                    ...
                                    <div className="w-full flex flex-col xl:flex-row xl:justify-between pt-2 text-sm">
