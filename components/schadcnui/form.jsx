...
import {Label} from "@/components/schadcnui/label";
...
const FormMessage = React.forwardRef(({className, children, ...props}, ref) => {
    ...
    return (
        <p ref={ref} id={formMessageId} className={cn("text-sm font-medium text-red-500", className)}
           {...props}>
            {body}
        </p>
    )
...
export {
    useFormField, Form, FormItem, FormLabel,
