...
import {Form, FormControl, FormField, FormItem, FormLabel, FormMessage} from "@/components/schadcnui/form";
...
const FormSection = () => {
    ...
    return (
        <div className="flex flex-col items-center space-y-4 py-16 px-8 md:px-16 shadow">
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)}
                      className="grid w-full max-w-screen-md grid-cols-1 sm:grid-cols-2 gap-8">
                    <h2 className="col-span-1 sm:col-span-2 text-2xl font-bold max-w-screen-md">
                    ...
                    <div className={"col-span-1"}>
                        <FormInputField form={form} name={"telefon"} label={"Telefon"} placeholder={""}/>
                    </div>
                    <div className={"col-span-1 sm:col-span-2"}>
                        <FormInputField form={form} name={"email"} label={"Email"} placeholder={""}/>
                    </div>
                    <div className={"col-span-1 sm:col-span-2"}>
                        <FormField control={form.control} name="file" render={({field}) =>
                            (<FormItem>
                                <FormLabel className={"font-semibold"}>Bilantul Companiei</FormLabel>
                                <FormControl>
