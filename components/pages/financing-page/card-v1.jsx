...
const CardV1 = ({availableFinancing}) => {
    ...
    return (
        <div className="group flex h-min flex-col w-full border border-gray-200 hover:border-white hover:shadow-all-3xl hover:scale-[1.01] duration-300">
            <div
            ...
            <div className="flex flex-1 w-full h-full flex-col p-4">
                ...
                <div
                    ...
                    <div className={"flex"}>
                        <div className={cn(availableFinancing["status"] === PROJECT_STATUS.OPENED && "bg-green-600", availableFinancing["status"] === PROJECT_STATUS.CLOSED && "bg-red-600", availableFinancing["status"] === PROJECT_STATUS.PENDING && "bg-orange-400", "h-min text-white px-2 py-1")}>
                ...
                <div
                    ...
                    <div className="flex flex-nowrap w-min space-x-2">
                        ...
                        <span className={cn("text-nowrap font-semibold", availableFinancing["end_date"] ? availableFinancing["end_date"] < dateNowInUnix ? "text-red-600" : "text-green-600" : "text-green-600")}>
